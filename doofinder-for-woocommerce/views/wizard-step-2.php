...
<form action="<?php echo Setup_Wizard::get_url(['step' => '2']); ?>" method="post" >
	<div class="dfwc-setup-step__actions">
		<button type="button" id="doofinder-for-wc-index-button"  class="button button-primary"><?php _e('Start', 'woocommerce-doofinder'); ?></button>
	...
	<div class="dfwc-setup-step__progress-bar-wrapper">
		...
		<?php
			...
			$index_interface->render_html_indexing_error();
		?>
	</div>
