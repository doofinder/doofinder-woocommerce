...
class Update_On_Save {
	...
	public static function register_hooks() {
		add_action(
			'wp_insert_post',
			function ( $post_id, \WP_Post $post, $updated ) {
	...
	public static function add_item_to_db( $doofinder_post, $post_id, $status, $type ) {
		...
		} elseif ( $doofinder_post->is_indexable() && in_array( $type, array( 'posts', 'product', 'pages' ) ) ) {
		...
		} elseif ( in_array( $type, array( 'posts', 'product', 'pages' ) ) ) {
