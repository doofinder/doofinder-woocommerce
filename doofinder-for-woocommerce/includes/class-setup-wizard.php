...
class Setup_Wizard {
	...
	private function check_api_settings( $step ) {
		...
		$api_host        = 'https://david-doomanager.ngrok.doofinder.com';    // i.e: https://eu1-admin.doofinder.com.
		$dooplugins_host = 'https://david-dooplugins.ngrok.doofinder.com';  // i.e: https://eu1-plugins.doofinder.com.
